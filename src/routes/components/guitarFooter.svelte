...
<div class="container">
    ...
    <div class="interactives">
        <a href="guitarras/{link}" class="button" aria-label="{$dictionary.masInformacion}">
            <ion-icon name="information-circle-outline"></ion-icon> 
            {$dictionary.masInformacion}
        </a>
        <div class="share">
            <ShareButton url="guitarras/{link}" title={name} edition={edition} description={description}/>
        </div>
    </div>
    </div>
